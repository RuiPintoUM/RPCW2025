...
# Caminhos
json_path = "ontologias/mestrados_utad.json"
ttl_base_path = "ontologias/cursos_povoados.ttl"
ttl_output_path = "ontologias/cursos_povoados_um_utad.ttl"
...
universidade = "Universidade de Trás-os-Montes e Alto Douro"
...
# Adicionar os regimes
regimes = ["Diurno", "Misto", "Noturno"]
...
for curso_uri in cursos:
    ...
    g.add((curso_uri_ref, EX.pertenceA, universidade_uri))
