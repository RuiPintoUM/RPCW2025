...
# Caminhos
json_path = "ontologias/mestrados_uc.json"
ttl_base_path = "ontologias/cursos_povoados_um_utad_fctnova.ttl"
ttl_output_path = "ontologias/cursos_povoados_um_utad_fctnova_uc.ttl"
